...
# DONE: Make a forward pass through the network
hidden_layer_in = np.matmul(X, weight_input_to_hidden)
hidden_layer_out = sigmoid(hidden_layer_in)
print('Hidden-layer Output:')
print(hidden_layer_out)

output_layer_in = np.matmul(hidden_layer_out, weight_hidden_to_output)
